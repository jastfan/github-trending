...
```
- **Repository URL:** [https://github.com/affaan-m/ECC](https://github.com/affaan-m/ECC)
- **Owner:** `@affaan-m`
</details>
...
> 📂 *Explore all 17 Go repos in [`archives/2026-09/2026-09-08.md`](archives/2026-09/2026-09-08.md)*

### 🦀 Rust

| # | Repository | Language | Topics | Stars Today | Total Stars | Description |
| :---: | :--- | :---: | :---: | :---: | :---: | :--- |
| 1 | [**1jehuang/jcode**](https://github.com/1jehuang/jcode) | `Rust` | - | **+74** | ★ 19,304 | The most RAM efficient harness |
| 2 | [**tonhowtf/omniget**](https://github.com/tonhowtf/omniget) | `Rust` | `#AI-Video` | **+72** | ★ 9,655 | Download Udemy and Hotmart courses, YouTube videos, music and books — 1,800+ sites, no terminal. Free open-source desktop app for Windows, macOS and Linux, with a built-in course player, PDF/EPUB reader and music library. Powered by yt-dlp. Your files stay on your computer. |
| 3 | [**nautechsystems/nautilus_trader**](https://github.com/nautechsystems/nautilus_trader) | `Rust` | `#Autonomous-Finance` | **+130** | ★ 28,617 | Production-grade Rust-native trading engine with deterministic event-driven architecture |
| 4 | [**louis-e/arnis**](https://github.com/louis-e/arnis) | `Rust` | `#Local-AI` | **+16** | ★ 17,768 | Generate any location from the real world in Minecraft with a high level of detail. |
